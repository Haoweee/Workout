        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-5">
          ...
          <div className="col-span-1">
            ...
            <div className="text-muted-foreground space-y-3">
              <a href="/exercise" className="block mt-2 hover:underline">
                Exercises
              </a>
              <a href="/community" className="block mt-2 hover:underline">
                Community
              </a>
            </div>
          </div>
          <div className="col-span-1">
            ...
            <div className="text-muted-foreground space-y-3">
              <a href="/terms-of-use" className="block mt-2 hover:underline">
                Terms of Use
              </a>
              <a href="/privacy-policy" className="block mt-2 hover:underline">
                Privacy Policy
              </a>
            </div>
          </div>
          <div className="col-span-1">
            ...
            <div className="text-muted-foreground space-y-3">
              <a href="/about" className="block mt-2 hover:underline">
                About Us
              </a>
              <a href="/contact" className="block mt-2 hover:underline">
                Contact
              </a>
              <a href="/blog" className="block mt-2 hover:underline">
                Blog
              </a>
            </div>
          </div>
