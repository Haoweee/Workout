...
import type { Day, Routine, RoutineFormData } from '@/types/routine';
import type { Exercise } from '@/types/exercise';

/**
 * Custom hook to manage routine form state and logic
 *
 * @param mode - 'create' or 'edit' to determine form behavior
 * @param existingRoutine - Optional existing routine data for edit mode
...
export const useRoutineForm = (mode: 'create' | 'edit', existingRoutine?: Routine) => {
  ...
  const [formData, setFormData] = useState<RoutineFormData>({
    ...
    difficulty:
      mode === 'edit'
        ? (existingRoutine?.difficulty as 'BEGINNER' | 'INTERMEDIATE' | 'ADVANCED') || 'BEGINNER'
        : 'BEGINNER',
